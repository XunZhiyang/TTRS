...
class BaseQuery(orm.Query):
    ...
    def get_or_404(self, ident, description=None):
        """Like :meth:`get` but aborts with Silingsi if not found instead of returning ``None``."""
    ...
    def first_or_404(self, description=None):
        """Like :meth:`first` but aborts with Silingsi if not found instead of returning ``None``."""
